...
<form action="kartu_controller.php" method="post">
    <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-8">
          <input id="nama" name="nama" type="text" class="form-control" value="<?= $krt['nama']?>">
        </div>
      </div>
      <div class="form-group row">
        <label for="text3" class="col-4 col-form-label">Diskon</label> 
        <div class="col-8">
          <input id="diskon" name="diskon" type="number" class="form-control" value="<?= $krt['diskon']?>">
        </div>
      </div>
      <div class="form-group row">
        <label for="text" class="col-4 col-form-label">Iuran</label> 
        <div class="col-8">
          <input id="iuran" name="iuran" type="number" class="form-control" value="<?= $krt['iuran']?>">
        </div>
      </div>  
      <div class="form-group row">
