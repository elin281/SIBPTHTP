...
<form method="post" action="{{url('admin/pegawai/store')}}" enctype="multipart/form-data">
  ...
  <div class="form-group row">
    <label for="text1" class="col-4 col-form-label"><b>NIP</b></label> 
    <div class="col-8">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <textarea id="textarea" name="alamat" cols="40" rows="5" class="form-control" placeholder="Masukkan Alamat"></textarea>
    </div>
  </div>
  <div class="form-group row">
